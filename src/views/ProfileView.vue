...
<template>
  ...
  <main id="profile" class="flex justify-center items-center px-16 py-20 bg-white max-md:px-5">
    <section class="flex flex-col items-center w-full max-w-[90%] max-md:max-w-full">
      <h1 class="mt-5 text-4xl font-bold font-primary text-center text-yellow-primary max-md:max-w-full">
        Wilayah Desa
      </h1>
      ...
      <h2 class="self-stretch mt-28 text-4xl font-bold text-center text-yellow-primary max-md:mt-10 max-md:max-w-full font-primary">
        Peta Desa
      </h2>
