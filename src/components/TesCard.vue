    ...
    <div class="max-w-lg mx-auto relative">
      ...
      >
        ...
        <article class="bg-white p-6 rounded-lg shadow-2xl">
          <header class="mb-2">
            <img
              class="inline-flex rounded-full shadow mb-3"
              src="./icon.svg"
              width="44"
              height="44"
              alt="Icon"
          ...
          <div class="text-sm leading-relaxed text-slate-500 space-y-4 mb-2">
            <p>
              ...
              model text, and a search for more variants will uncover many web sites still in their
              infancy.
            </p>
            <p>
          ...
          <footer class="text-right">
            <a class="text-sm font-medium text-indigo-500 hover:underline" href="#0"
              >Read more -></a
            >
          </footer>
        </article>
